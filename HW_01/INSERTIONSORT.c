...
void insertionsort(int* A, int n)
{
   ...
   printf("El tiempo que se tardo en ejecutar insertionsort en segundos es: %2.3f\n", segundos);
   printf("El tiempo que se tardo en ejecutar insertionsort en milisegundos es: %f\n", milisegundos);
}
